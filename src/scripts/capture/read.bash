...
# # Run tshark to read the latest .pcap file and filter UDP data
# echo 'semicolon' | sudo tshark -r "$latest_pcap" -Y "udp" -T fields -e data


# Run tshark to read the latest .pcap file and extract the hex data
echo 'semicolon' | sudo tshark -r "$latest_pcap" -Y "udp" -T fields -e data | while read -r line; do
